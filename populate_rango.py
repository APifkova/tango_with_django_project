...
def populate():
    python_pages = [
        {'title': 'Official Python Tutorial', 'url':'http://docs.python.org/3/tutorial/', 'views':19},
        {'title': 'How to Think like a Computer Scientist',
         'url':'http://www.greenteapress.com/thinkpython/', 'views':27},
    ...
    django_pages = [
        ...
        {'title': 'How to Tango with Django', 'url': 'http://www.tangowithdjango.com/', 'views':25}]

    other_pages = [
        {'title': 'Bottle', 'url':'http://bottlepy.org/docs/dev/', 'views':13},
        {'title': 'Flask', 'url': 'http://flask.pocoo.org', 'views':19}]
